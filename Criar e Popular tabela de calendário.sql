-- Disponível em https://medium.com/justdataplease/building-a-dynamic-date-calendar-in-postgresql-a-step-by-step-guide-20c8edfc3bf7, no dia 15/01/2024
...
SELECT * FROM date_calendar;SELECT * FROM date_calendar;